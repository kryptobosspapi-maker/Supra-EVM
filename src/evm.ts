...
function chunkBytesToWords(bytes: Uint8Array): bigint[] {
  if (bytes.length === 0) {
    return [];
  }
...
export class SupraEVM {
  ...
  private returnData = new Uint8Array(0);
...
export function hexToBytecode(hex: string): Uint8Array {
